...
PYBIND11_MODULE(mustache, handle) {
    ...
    handle.def("world_to_screen", &math::worldToScreen, pybind11::arg("pos"), pybind11::arg("out"),
               pybind11::arg("view_matrix"), pybind11::arg("window_width"), pybind11::arg("window_height"));

    // py-matrix f[16]
    pybind11::class_<math::ViewMatrix>(handle, "ViewMatrix")
            .def(pybind11::init<>())
            .def(
                    "__getitem__",
    ...
    // py-vector
    pybind11::class_<math::Vector>(handle, "Vector")
            .def(pybind11::init<>())
            .def(pybind11::init<float, float, float>())
            .def(pybind11::init<const math::Vector &>())
            .def("world_to_screen", &math::Vector::worldToScreen, pybind11::arg("view_matrix"),
                 pybind11::arg("window_width"), pybind11::arg("window_height"))
            .def("distance", &math::Vector::distance, pybind11::arg("other"))
            .def("is_zero", &math::Vector::isZero);

    // py-enum
    pybind11::enum_<ACCESS_LEVEL>(handle, "ACCESS_LEVEL").value("READ", ACCESS_LEVEL::READ_ONLY).value("WRITE",
                                                                                                       ACCESS_LEVEL::READ_WRITE).value(
            "ALL", ACCESS_LEVEL::ALL_ACCESS);
    ...
    pybind11::class_<Memory>(handle, "Memory")
            .def(pybind11::init<const std::string_view, ACCESS_LEVEL>(), pybind11::arg("process_name"),
                 pybind11::arg("access_level") = ACCESS_LEVEL::READ_ONLY)
            ...
            .def("get_module_size", &Memory::getModuleSize, pybind11::return_value_policy::reference)
